(function (global, factory) {
	 ...
	 */
	var l=Symbol.for("react.element"),n=Symbol.for("react.portal"),p=Symbol.for("react.fragment"),q=Symbol.for("react.strict_mode"),r=Symbol.for("react.profiler"),t$1=Symbol.for("react.provider"),u=Symbol.for("react.context"),v=Symbol.for("react.forward_ref"),w=Symbol.for("react.suspense"),x=Symbol.for("react.memo"),y=Symbol.for("react.lazy"),z=Symbol.iterator;function A(a){if(null===a||"object"!==typeof a)return null;a=z&&a[z]||a["@@iterator"];return "function"===typeof a?a:null}
	...
	for(var m=0;m<f;m++)g[m]=arguments[m+2];d.children=g;}return {$$typeof:l,type:a.type,key:c,ref:k,props:d,_owner:h}};var createContext=function(a){a={$$typeof:u,_currentValue:a,_currentValue2:a,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null};a.Provider={$$typeof:t$1,_context:a};return a.Consumer=a};var createElement=M;var createFactory=function(a){var b=M.bind(null,a);b.type=a;return b};var createRef=function(){return {current:null}};
	...
	function useDebug() {
	  ...
	  var debug = react.useMemo(function () {
	    return isClient && (window.location.href.includes('#debug') || process.env.NODE_ENV === 'development') && !window.location.href.includes('#production');
	  }, [isClient]);
	  return debug;
	}
	...
	function useFrame(callback, priority) {
	  ...
	  react.useEffect(function () {
	    if (callback) {
	      t.add(callback, priority);
	      return function () {
	        return t.remove(callback);
	      };
	    }
	  }, [callback, priority]);
	}
	...
	*/
	...
	function useIsVisible(_temp) {
	  ...
	  var callbackFunction = react.useCallback(function (entries) {
	    var entry = entries[0];
	...
	function useMediaQuery(queryString) {
	  var isClient = useIsClient();
	  var mediaQuery = react.useMemo(function () {
	    if (isClient) {
	      try {
	...
	function useRect(_temp) {
	  ...
	  var _useState = react.useState({}),
	    rect = _useState[0],
	    setRect = _useState[1];
	  var lazyRect = react.useRef(rect);
	  var resize = react.useCallback(function () {
	    if (element.current) {
	      var top = offsetTop(element.current);
	      var left = offsetLeft(element.current);
	      lazyRect.current = _extends({}, lazyRect.current, {
	        top: top,
	        left: left
	      });
	      if (!lazy) {
	  ...
	  react.useEffect(function () {
	    var callback = throttle(debounce, resize);
	  ...
	  var onResizeObserver = react.useCallback(function (_ref2) {
	    var entry = _ref2[0];
